...
AUTH_CHANNEL = environ.get("AUTH_CHANNEL", "-1003205691732 -1003215102305 -1002834808662") # add multiple channels here, separated by single space
AUTH_CHANNEL = [int(ch) for ch in AUTH_CHANNEL.strip().split()] if AUTH_CHANNEL else []
AUTH_REQ_CHANNEL = environ.get('AUTH_REQ_CHANNEL', '-1003205691732 -1003215102305') # add multiple channels here, separated by single space
