...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+XOO-8rE-57Q3ZjU1')
...
AUTH_CHANNEL = environ.get("AUTH_CHANNEL", "-1002834808662 -1003848200993") # add multiple channels here, separated by single space
AUTH_CHANNEL = [int(ch) for ch in AUTH_CHANNEL.strip().split()] if AUTH_CHANNEL else []
AUTH_REQ_CHANNEL = environ.get('AUTH_REQ_CHANNEL', '-1003848200993') # add multiple channels here, separated by single space
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/How_to_verify_tokens")
...
SHORTENER_API = environ.get("SHORTENER_API", "arolinks.com")
...
SHORTENER_API3 = environ.get("SHORTENER_API3", "https://arolinks.com")
SHORTENER_WEBSITE3 = environ.get("SHORTENER_WEBSITE3", "400943cae6dd48a8143eba5a5f055d4bad4c92f8")
